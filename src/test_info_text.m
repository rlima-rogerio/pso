...
% Returns struct 'info'.
    ...
    % ---------------- Defaults ----------------
    info = struct( ...
        'battery',   struct('num_cells', 3, 'capacity_mAh', 2200, 'charge_state', "Full"), ...
        'esc',       struct('model', "Flier-80A", 'configuration', "Default"), ...
        'motor',     struct('model', "GT2826-04", 'kv', 1090), ...
        'propeller', struct('model', "Carbon fiber", 'size_in', "15x10", 'rotation', "CW", 'balanced', true), ...

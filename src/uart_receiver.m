...
if CALIBRATION_MODE
    ...
    if exist('test_information')
        base = "test_" + ...
                ...
                test_information.esc.model + "_" + ...
                test_information.motor.model + "_" + ...
                test_information.propeller.model + "-" + ...
                test_information.propeller.size_in;
    else
        base = "test_" + string(datestr(ts, "yyyy-mm-dd_HH-MM-SS"));
    end
